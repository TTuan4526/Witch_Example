...
public class EnemySlimeFire : MonoBehaviour
{
	public Vector3 end;
	...
	public void SpawnMonster()
	{
		...
		facing_right = true;
		dead = false;
		GetComponent<Animator>().Play("enemy_slime_fire_idle");
	...
	private void Dead()
	{
		...
		anim.Play("enemy_slime_fire_death");
	...
	public void DamageFromRight(int amount)
	{
		...
		source.Play();
		anim.Play("enemy_slime_fire_damaged");
		damaging = true;
		rbody.velocity = new Vector2(0f, 0f);
