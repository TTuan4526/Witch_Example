...
public class ice_cave_spike : MonoBehaviour
{
	...
	public void SpawnItem()
	{
		...
		anim.Play("ice_spike_" + index + "_appear");
		StopAllCoroutines();
	...
	public void Broke()
	{
		...
		broken = true;
		rbody.velocity = new Vector3(0f, 0f, 0f);
		anim.Play("ice_spike_" + index + "_explode");
	}

	private IEnumerator FinallyFall()
	{
		anim.Play("ice_spike_" + index + "_shake");
		yield return new WaitForSeconds(0.2f);
		anim.Play("ice_spike_" + index + "_idle");
