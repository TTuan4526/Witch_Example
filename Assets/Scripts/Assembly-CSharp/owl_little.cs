...
public class owl_little : MonoBehaviour
{
	...
	{
		dead = false;
		base.transform.localPosition = new Vector3(default_start.x, default_start.y, -2f);
		base.transform.localScale = default_scale;
		GetComponent<Animator>().Play("little_owl_idle");
