...
public class EndDialog : MonoBehaviour
{
	...
	private LocalizationTavern local;
	...
	private void Start()
	{
		...
		local = GameObject.FindGameObjectWithTag("common").GetComponent<LocalizationTavern>();
	}
	...
	private void Update()
	{
		...
		{
			conv_ended = true;
			GameObject.FindGameObjectWithTag("common").GetComponent<Tavern>().LoadSceneAsyncronical("outro");
